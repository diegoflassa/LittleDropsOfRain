package io.github.diegoflassa.littledropsofrain.auth
...
import io.github.diegoflassa.littledropsofrain.BaseActivity
import io.github.diegoflassa.littledropsofrain.R
import io.github.diegoflassa.littledropsofrain.databinding.ActivityPhoneAuthBinding
...
class MultiFactorEnrollActivity : BaseActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.titleText.text = getString(R.string.sms_as_a_second_factor)
