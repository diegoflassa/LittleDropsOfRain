...
object Versions {
    ...
    const val preference_ktx = "1.2.0-beta01"
    const val recyclerview = "1.3.0-alpha01"
    const val recyclerview_selection = "1.2.0-alpha01"
    const val accompanist_pager = "0.21.3-beta"
    const val accompanist_swiperefresh = "0.21.3-beta"
    ...
    const val androidx_jetpack_compose = "1.1.0-beta03"
