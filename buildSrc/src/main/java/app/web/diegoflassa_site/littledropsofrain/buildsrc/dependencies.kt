...
object Versions {
    ...
    const val kotlinStdlibJdk8 = "1.4.30"
    const val gradle_plugin="1.4.30"
    const val gradle="7.0.0-alpha08"
    const val coil = "1.0.0"
    const val data_store = "1.0.0-alpha07"
    ...
    const val core = "1.3.1-alpha04"
    const val expresso = "3.3.0"
    const val junit_ktx = "1.1.3-alpha04"
    ...
    const val androidxJetpackCompose = "1.0.0-beta01"
