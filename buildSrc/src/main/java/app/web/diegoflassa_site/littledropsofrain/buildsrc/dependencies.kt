...
object Versions {
    ...
    const val gradle = "7.1.0-alpha07"
    ...
    const val fragment_ktx = "1.4.0-alpha06"
    ...
    const val databinding = "7.1.0-alpha08"
    const val core = "1.4.0"
    const val espresso = "3.4.0"
    const val test = "1.4.0"
    const val junit_ktx = "1.1.3"
    const val safeargs_plugin = "2.4.0-alpha05"
    ...
    const val androidx_jetpack_compose = "1.1.0-alpha01"
    const val foundation = "1.0.0-alpha11"
    const val braintree = "4.4.1"
}