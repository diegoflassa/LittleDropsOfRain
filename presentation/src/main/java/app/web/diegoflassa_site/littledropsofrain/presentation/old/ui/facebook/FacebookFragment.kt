...
package app.web.diegoflassa_site.littledropsofrain.presentation.old.ui.facebook
...
import app.web.diegoflassa_site.littledropsofrain.presentation.OldMainActivity
import app.web.diegoflassa_site.littledropsofrain.presentation.old.helper.viewLifecycle
import app.web.diegoflassa_site.littledropsofrain.presentation.old.interfaces.OnKeyLongPressListener
...
class FacebookFragment : Fragment(), OnKeyLongPressListener {
    ...
    val viewModel: FacebookViewModel by viewModels()
    ...
    override fun onCreateView(
        ...
        (activity as OldMainActivity).mOnKeyLongPressListener = this
    ...
    override fun onStop() {
        isStopped = true
        (activity as OldMainActivity).mOnKeyLongPressListener = null
