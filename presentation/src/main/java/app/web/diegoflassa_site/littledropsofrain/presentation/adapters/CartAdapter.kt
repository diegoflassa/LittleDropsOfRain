...
open class CartAdapter(
    ...
    override fun onCreateViewHolder(
        ...
        return ViewHolder(cartFragment, binding.root)
    }
    ...
    class ViewHolder(private var cartFragment: CartFragment, itemView: View) :
        ...
        fun bind(
            ...
            if (product != null) {
                ...
                for (category in product.categories) {
                    if (category.isNotEmpty()) {
                        ...
                        chipCategory.isChecked =
                            cartFragment.mFilterDialog?.categories!!.contains(category)
                ...
                val heartIcon =
                    IconDrawable(cartFragment.requireContext(), SimpleLineIconsIcons.icon_heart)
        ...
        override fun onCheckedChanged(p0: CompoundButton?, p1: Boolean) {
            cartFragment.mFilterDialog?.onCheckedChanged(p0, p1)
            cartFragment.onFilter(cartFragment.mFilterDialog!!.filters)
        }
    }
}
